  ...
  void hitung() {
    setState(() {
      ...
      if (hasil >= 18.5 && hasil < 23) {
        ...
        teks = "$nama, wah berat badan kamu kelebihan nih nge gym yuk :)";
      } else if (hasil >= 25 && hasil < 30) {
        teks =
            "$nama, wadduh berat badan kamu sangat kelebihan, Kamu pada Obese Level 1. jangan lupa olahraga dan atur pola makan dan yang paling penting keeps smile :D";
      } else if (hasil >= 30) {
        teks =
            "$nama, wadduh berat badan kamu sangat kelebihan, Kamu pada Obese Level 2. jangan lupa olahraga dan atur pola makan dan yang paling penting keeps smile :D";
      } else if (hasil >= 17) {
        teks =
            "$nama, yahhh kamu ringat banget nich, jangan lupa atur pola makan,pola tidur,dan banyak berolahraga";
      } else {
        teks =
            "$nama, yahhh kamu ringat banget nich, jangan lupa atur pola makan,pola tidur,dan banyak berolahraga";
      }
